...
人生苦短，我用Python，CyberCAM大部分应用都是通过Python编程实现，为了照顾没有python基础的朋友，我们一直在思考应该给大家提供怎么样的教程。

Python相关的书籍和学习资料相信大家能在网上找到不少，所以这里整理给大家的经典的python3快速学习资料，你甚至可以使用它来当作python字典查阅！
