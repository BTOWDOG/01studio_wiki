...
```mermaid
graph TD
    导入KPU等相关模块  --> 加载相关模型 --> 获取摄像头图像 --> AI视觉推理查找图像中人脸 --> 判断是否戴口罩 --> 画图描绘 --> 获取摄像头图像;
```
...
![hand_detection](./img/mask_det/mask_det.jpg)

识别结果：

![hand_detection](./img/mask_det/mask_det2.png)

- 未戴口罩场景：

原图：

![hand_detection](./img/mask_det/mask_det3.png)

识别结果：

![hand_detection](./img/mask_det/mask_det4.png)
