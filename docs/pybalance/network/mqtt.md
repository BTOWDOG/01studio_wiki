...
if WIFI_Connect():
    ...
    PORT = 18830
    CLIENT_ID = 'pyBalance-ESP32-S3' # 客户端ID
...
if WIFI_Connect():
    ...
    SERVER = 'mq.tongxinmao.com'
    PORT = 18830
    CLIENT_ID = 'pyBalance-ESP32-S2' # 客户端ID
    TOPIC = '/public/01Studio/1' # TOPIC名称
...
订阅者”代码测试方法跟“发布者”相反。在MQTT助手中发布主题填写为：'/public/01Studio/1。在箭头所指的输入框中输入需要发送的内容。

![mqtt](./img/mqtt/mqtt9.png)

运行订阅者代码，可以看到Thonny IDE下方终端打印接收到的数据。
